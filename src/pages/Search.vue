          ...
          <form @submit.prevent="fetchSearchResults" class="grid md:grid-cols-5 sm:grid-cols-1">
              ...
              <div>
                ...
                <div class="text-center">
                  <input class="md:w-2/5 rounded-lg focus:ring-2 focus:ring-inset focus:ring-accent border-none bg-gray-200 text-center" name="radius" id="radius" type="number" value="20" v-model="filterRadius" min="0">
                </div>
              </div>
              ...
              <div>
                ...
                <div class="text-center">
                  <input class="md:w-2/5 rounded-lg focus:ring-2 focus:ring-inset focus:ring-accent border-none bg-gray-200 text-center" name="rooms" id="rooms" type="number" value="1" v-model="rooms" min="1">
                </div>
              </div>
              ...
              <div>
                ...
                <div class="text-center">
                  <input class="md:w-2/5 rounded-lg focus:ring-2 focus:ring-inset focus:ring-accent border-none bg-gray-200 text-center" name="beds" id="beds" type="number" value="1" v-model="beds" min="1">
                </div>
              </div>
